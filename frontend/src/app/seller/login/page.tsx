...
export default function SellerLoginPage() {
  ...
  return (
    <div className="mx-auto max-w-md px-5 py-20">
      <p className="label-text text-terracotta">Seller Login</p>
      <h1 className="mt-2 font-display text-3xl text-ink">Your shop dashboard</h1>
      <p className="mt-2 text-sm text-ink-soft/70">Sign in to manage your shop on Artist.</p>
      ...
      <p className="mt-6 text-sm text-ink-soft/70 text-center">
        New to selling on Artist?{" "}
        <Link href="/seller/register" className="text-terracotta hover:underline">
          Apply here
        </Link>
      </p>
    </div>
